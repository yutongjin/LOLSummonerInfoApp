      ...
      <Table size="small">
        <TableHead>
          <TableRow>
            ...
            <TableCell align="center">championPoints</TableCell>
            <TableCell align="right">Total Games</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {props.masteries.map((champion) => (
            <TableRow key={champion.championId}>
              <TableCell align="center">{champion.summonerId}</TableCell>

              <TableCell align="center">
                {Champion(champion.championId).name}
              </TableCell>
              <TableCell align="center">{champion.championLevel}</TableCell>
              <TableCell align="center">{champion.championPoints}</TableCell>
              <TableCell align="center">{champion.totalGameNumbers}</TableCell>

              {/*    <TableCell>{champion.paymentMethod}</TableCell>
